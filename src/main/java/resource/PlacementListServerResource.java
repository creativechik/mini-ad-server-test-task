    ...
    public PlacementListRepresentation getPlacements() {
        try {
            ...
            for (Placement placement : placements) {
                PlacementRepresentation placementRepr = PlacementUtils.toPlacementRepresentation(placement);
                placementRepr.setSelf(ResourceUtils.getPlacementUrl(String.valueOf(placement.getId())));
